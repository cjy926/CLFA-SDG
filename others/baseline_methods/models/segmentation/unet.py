...
from others.baseline_methods.layers.unet_blocks import *
from others.baseline_methods.layers.superpixel import SuperResolutionModule
...
class Unet(nn.Module):
    ...
    def forward(self, x):
        ...
        # print('bbbbbbbbbbbbbb', out.size(), x.size())
        if out.size()[2:] != x.size()[2:] and not self.super_reso:
...
class NestedUNet(nn.Module):
    def __init__(self, input_channels=3, num_classes=1, deep_supervision=False, layer_attention=False, **kwargs):
        super().__init__()
